...
import com.ngochuy.ecommerce.feature.invocie.adapter.PaymentAdapter
 ...
 */
class PaymentInvocieFragment :Fragment(){
    ...
    private val invoiceAdapter: PaymentAdapter by lazy {
        PaymentAdapter { id -> showProduct(id) }
    }
