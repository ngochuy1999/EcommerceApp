...
class ItemConfirmFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_item_confirm, container, false)
        ...
        if (view is RecyclerView) {
            with(view) {
                ...
                adapter = ItemConfirmRecyclerViewAdapter(DummyContent.ITEMS)
            }
        }
        return view
    }
